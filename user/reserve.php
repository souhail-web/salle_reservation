                    ...
                    <div class="p-6">
                        ...
                        <div class="space-y-4 pt-4 border-t border-gray-100">
                            <div class="flex items-start">
                                ...
                                <div class="ml-3">
                                    <p class="text-sm font-medium text-gray-700">Équipements inclus</p>
                                    <p class="text-sm text-gray-500 mt-1">
                                        ...
                                        if (!empty($features)) {
                                            ...
                                            foreach ($features as $feature) {
                                                echo '<li class="text-sm text-gray-600">' . htmlspecialchars(trim($feature)) . '</li>';
                                            }
                                            echo '</ul>';
                                        } else {
                                            echo 'Aucun équipement spécifié';
                                        }
                                        ?>
                                    </p>
                                </div>
                            ...
                            <div class="flex items-start">
                                ...
                                <div class="ml-3">
                                    <p class="text-sm font-medium text-gray-700">Horaires d'ouverture</p>
                                    <p class="text-sm text-gray-500">Lundi - Vendredi: 8h - 20h</p>
                                    <p class="text-sm text-gray-500">Samedi: 9h - 18h</p>
                            ...
                            <div class="flex items-start">
                                ...
                                <div class="ml-3">
                                    ...
                                    <p class="text-sm text-gray-500 mt-1">Contactez-nous au <a href="tel:+33123456789" class="text-blue-600 hover:text-blue-800">01 23 45 67 89</a></p>
